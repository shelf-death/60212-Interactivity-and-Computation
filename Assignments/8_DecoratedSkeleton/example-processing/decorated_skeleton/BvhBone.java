...
public class BvhBone {
  ...
  public String _name;
  public ArrayList<PVector> duplicates = new ArrayList<PVector>();
  ...
  {
    _name = value;
    if (_name != null && _name.equals("LeftShoulder")) {
      System.out.println(_name);
      PVector test = new PVector(200, 0, 0);
      duplicates.add(test);
      test = new PVector(-200, 0, 0);
      duplicates.add(test);
    }
